...
def main() -> None:
    ...
    print(root / "apps/strategy/<family>.py")
    print(root / "tests/unit/strategies/test_<family>.py")
    ...
    print(root / "skills/Strategy_Writer/scripts/<strategy_slug>/run_research.py")
